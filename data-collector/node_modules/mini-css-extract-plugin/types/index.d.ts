...
type Schema = import("mini-css-extract-plugin/node_modules/schema-utils/declarations/validate").Schema;
...
type LoaderDependency = import("mini-css-extract-plugin/types/loader").Dependency;
type LoaderOptions = {
  publicPath?:
    | string
